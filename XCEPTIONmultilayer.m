% Definir o tamanho de entrada esperado pela Xception
inputSize = [299, 299, 3]; % O tamanho de entrada da Xception é 299x299
...
% Definir as camadas de interesse do Xception
layers = {'predictions', 'avg_pool'}; % Use os nomes corretos aqui
