...
imds = imageDatastore('MEDIA', 'IncludeSubfolders', true, 'LabelSource', 'foldernames');
...
YTrain = double(imdsTrain.Labels); % Converte os rótulos em valores numéricos
YTrain(strcmp(imdsTrain.Labels, '3.1429')) = 3.1429;
YTrain(strcmp(imdsTrain.Labels, '0.2857')) = 0.2857;
YTrain(strcmp(imdsTrain.Labels, '0.7143')) = 0.7143;
YTrain(strcmp(imdsTrain.Labels, '1')) = 1;
YTrain(strcmp(imdsTrain.Labels, '0')) = 0;
YTrain(strcmp(imdsTrain.Labels, '0.1429')) = 0.1429;
YTrain(strcmp(imdsTrain.Labels, '1.1429')) = 1.1429;
YTrain(strcmp(imdsTrain.Labels, '0.5714')) = 0.5714;
YTrain(strcmp(imdsTrain.Labels, '1.5714')) = 1.5714;
YTrain(strcmp(imdsTrain.Labels, '1.7143')) = 1.7143;
YTrain(strcmp(imdsTrain.Labels, '2.1429')) = 2.1429;
YTrain(strcmp(imdsTrain.Labels, '0.4286')) = 0.4286;
YTrain(strcmp(imdsTrain.Labels, '1.2857')) = 1.2857;
YTrain(strcmp(imdsTrain.Labels, '-1')) = -1;

YTest(strcmp(imdsTest.Labels, '3.1429')) = 3.1429;
YTest(strcmp(imdsTest.Labels, '0.2857')) = 0.2857;
YTest(strcmp(imdsTest.Labels, '0.7143')) = 0.7143;
YTest(strcmp(imdsTest.Labels, '1')) = 1;
YTest(strcmp(imdsTest.Labels, '0')) = 0;
YTest(strcmp(imdsTest.Labels, '0.1429')) = 0.1429;
YTest(strcmp(imdsTest.Labels, '1.1429')) = 1.1429;
YTest(strcmp(imdsTest.Labels, '0.5714')) = 0.5714;
YTest(strcmp(imdsTest.Labels, '1.5714')) = 1.5714;
YTest(strcmp(imdsTest.Labels, '1.7143')) = 1.7143;
YTest(strcmp(imdsTest.Labels, '2.1429')) = 2.1429;
YTest(strcmp(imdsTest.Labels, '0.4286')) = 0.4286;
YTest(strcmp(imdsTest.Labels, '1.2857')) = 1.2857;
YTest(strcmp(imdsTest.Labels, '-1')) = -1;
